...
<html lang="en">
  ...
  <div class="form-group col-md-3">
    ...
    <input type="text" class="form-control" name="username" autofocus="" required="" value="admin">
  </div>
  <div class="form-group col-md-3">
 ...
 <?php
    ...
    if(isset($_POST['loginAdmin'])){
        ...
        $DataMember = $koneksi->query("SELECT * FROM admin WHERE username ='$username'");
